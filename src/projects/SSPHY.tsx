...
const SmartBPM: ProjectComponent = () => {
  const projectData = {
    title: 'SSHPY',
    description: 'Prototpye of an iot-component that is used to non-invasively make conventional blood pressure monitors smart. Component interfaces with a companion app over bluetooth and hosts an embedded webserver to enable streaming readings over internet. ',
    technologies: ['ESP32', 'Embedded Systems', 'Pressure Meters', 'Sphygmomanometers', 'Medical Analytics'],
    status: 'completed' as const,
    demoUrl: '',
    githubUrl: 'https://drive.google.com/drive/folders/1OjvUDeLCtRupP2ngtqEyCILDGUt5UxXm?usp=sharing',
    images: [
      "public/assets/project_imgs/ssphy_1.png",
      "public/assets/project_imgs/ssphy_2.png",
      "public/assets/project_imgs/ssphy_3.jpg", 
      "public/assets/project_imgs/ssphy_4.jpg", 
      //'https://images.pexels.com/photos/230544/pexels-photo-230544.jpeg?auto=compress&cs=tinysrgb&w=800',
      //'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&cs=tinysrgb&w=800'
    ],
    features: [
      'Based on the ESP32 microcontroller',
      'OCR support for inputting readings',
      'Onboard sqlite database to persist readings for as long as needed',
      'Companion app (mobile and web)',
      'Open source'
    ],
    challenges: [
    ],
...
SmartBPM.title = 'SSPHY';
SmartBPM.description = 'SHPY plus smarts';

export default SmartBPM;
...
const TalkingPapers: ProjectComponent = () => {
  const projectData = {
    title: 'Talking Papers',
    description: 'Tool for parsing and understanding historical documents interactively. Documents are treated like a continuous token stream so you can find the most minute detail across a very large corpus. Users can prompt the system to explain, extract information or dynamically highlight interesting sections (bboxes).',
    ...
    features: [
      'Retrieves across 10k+ (250k document sections) archived Nigerian newspapers.',
      'Supports semantic and keyword searching (FTS5)',
      'Semantic search is implemented on a sentence-transformer (all-MiniLM-L12-v2), uses faiss for embeddings, onnx runtime ',
      'Extraction pipeline is based on paddlestructv3 and dotsocr and running on 2 x T4 and A100 gpus respectively',
    ],
    challenges: [
    ],
    learnings: [
...
TalkingPapers.title = 'Talking Papers';
TalkingPapers.description = 'Interactive Retrieval';

export default TalkingPapers;
...
const AutomatedEcgProcessing: ProjectComponent = () => {
  const projectData = {
    title: 'ECGML',
    description: 'Protype of an IoT powered wearable for ECG realtime acquisition, processing and classification using support vectors and nearest neighbours machine learning algorithms.',
    technologies: ['Machine Learning', 'Support Vector Algorithm', 'ESP32', 'Electrocardiogram', 'Analog-to-Digital', 'Graphana', 'AWS-IoT'],
    status: 'completed' as const,
    demoUrl: '',
    githubUrl: 'https://drive.google.com/drive/folders/1_TESOkEH0ccAFHyTx3DMhy6yWDbSqSEI?usp=sharing',
    images: [
      "public/assets/project_imgs/ecg_auto_1.png",
      "public/assets/project_imgs/ecg_auto_2.png",  
...
AutomatedEcgProcessing.title = 'ECGML';
AutomatedEcgProcessing.description = 'Realtime ECG classification';

...
const HealthMetrics: ProjectComponent = () => {
  const projectData = {
    title: 'Wearable 2',
    description: 'Collects health metrics like spo2, heartrate, step count, temperature and makes it queryable using natural language through RAG.',
    technologies: ['Machine Learning', 'TensorFlow.js', 'RAG', 'Medical'],
    status: 'completed' as const,
    demoUrl: '',
    githubUrl: 'https://github.com/yourusername/yolo-v11-camera',
    images: [
      "public/assets/project_imgs/health_metrics_1.png",
      "public/assets/project_imgs/health_metrics_2.png",  
    ...
    features: [
      ...
      'Supports querying database using natural language',
      'Open source'
    ],
    challenges: [
    ],
...
HealthMetrics.title = 'Wearable 2';
HealthMetrics.description = 'Health KPIs';
